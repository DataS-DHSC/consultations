...
#' @param text_col column name containing free text to be analysed
...
#' @export
#'
#' @examples unnest_stem_and_remove_stopwords(dummy_response, colnames(dummy_response)[7], "words")
unnest_stem_and_remove_stopwords <- function(data, text_col, token = "words"){
  dummy_response %>%
